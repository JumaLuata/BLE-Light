...
PRIMARY_SERVICE(service_gap, gBleSig_GenericAccessProfile_d)
    CHARACTERISTIC(char_device_name, gBleSig_GapDeviceName_d, (gGattCharPropRead_c | gGattCharPropWrite_c) )
            VALUE(value_device_name, gBleSig_GapDeviceName_d, (gPermissionFlagReadable_c | gPermissionFlagWritable_c), 13, "FSL_BLE_Light")
...
//LED
PRIMARY_SERVICE(service_LED_Control, gBleSig_ImmediateAlertService_d)
    CHARACTERISTIC(char_led_status_ctrl_point, gBleSig_HidCtrlPoint_d, (gGattCharPropWriteWithoutRsp_c))
        VALUE(value_led_status_ctrl_point, gBleSig_HidCtrlPoint_d, (gPermissionFlagWritable_c), 1, 0x00)
    CHARACTERISTIC(char_led_status_str, gBleSig_HidInformation_d, (gGattCharPropNotify_c))
        VALUE(value_led_status_str, gBleSig_HidInformation_d, (gPermissionFlagReadable_c), 8, 0x4c,0x45,0x44,0x20,0x49,0x6e,0x66,0x6f)
        DESCRIPTOR(desc_led_status, gBleSig_CharPresFormatDescriptor_d, (gPermissionFlagReadable_c), 16,"LED Status")
        CCCD(cccd_led_status) 
...
PRIMARY_SERVICE(service_device_info, gBleSig_DeviceInformationService_d)
    ...
    CHARACTERISTIC(char_model_no, gBleSig_ModelNumberString_d, (gGattCharPropRead_c) )
        VALUE(value_model_no, gBleSig_ModelNumberString_d, (gPermissionFlagReadable_c), 9, "BLE Light")
